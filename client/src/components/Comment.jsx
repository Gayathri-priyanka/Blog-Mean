    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
          <button type='button' className={`text-gray-400 hover:text-cyan-600 ${currentUser && comment.likes.includes(currentUser._id) && '!text-blue-500'}` } onClick={()=>onLike(comment._id)}> 
          ...
          </p>
          {
            currentUser && (currentUser._id === comment.userId  || currentUser.isAdmin) && (
              ...
              <button type='button' onClick={()=>onDelete(comment._id)} className='text-gray-400 hover:text-blue-500'>Delete</button>
              </>
          )
          }
        </div>
