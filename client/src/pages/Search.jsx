    ...
    useEffect(()=>{
        ...
        if(searchTermFromUrl || sortFromUrl ||categoryFromUrl){
            setSidebarData({
                ...
                sort:sortFromUrl,
                category: categoryFromUrl && categoryFromUrl !== 'null' ? categoryFromUrl : 'uncategorized',
            });
        }
        ...
        const fetchPosts= async()=>{
            ...
            console.log("API request URL:", `/api/post/getposts?${searchQuery}`);
        ...
        fetchPosts();
        console.log("Current sidebarData:", sidebarData);
